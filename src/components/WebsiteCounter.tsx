...
const WebsiteCounter: React.FC<WebsiteCounterProps> = ({
    ...
    const updateWebsiteData = useCallback((newData: WebsiteCounterData[]) => {
    ...
    const handleAddWebsite = useCallback(async () => {
        ...
        try {
            const url = new URL(newWebsiteUrl.startsWith('http') ? newWebsiteUrl : `https://${newWebsiteUrl}`);
            ...
            const newSite: WebsiteCounterData = {
                ...
                count: 0,
                lastVisited: 0,
                favicon: showFavicons ? `https://www.google.com/s2/favicons?domain=${hostname}&sz=32` : undefined
            };
    ...
    const handleRemoveWebsite = useCallback((hostname: string) => {
        ...
        <div className={`website-counter-widget ${className}`}>
            <div className="widget-header">
                ...
                <div className="counter-stats">
                    ...
                    <span className="tracked-sites">{websiteData.length}/{maxWebsites} sites</span>
                </div>
            </div>
            ...
            {!isLocked && (<div className="counter-controls">
                {!isAddingWebsite ? (
