...
const WidgetManager: React.FC<WidgetManagerProps> = ({
  ...
  const renderWidgetTypeCard = useCallback(
    (widgetType: WidgetType) =>
      (() => {
  ...
  const renderDimensionInput = useCallback(
    (dimension: 'width' | 'height', value: number, min: number, max: number) => (
      <div className="dimension-field">
        <label className="dimension-label">{t(`widgetManager.labels.${dimension}`)}</label>
  ...
  const renderPositionInput = useCallback(
    (axis: 'x' | 'y', value: number, translationKey: string) => (
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div className="form-section">
                ...
                <div className="widget-types">{availableWidgets.map(renderWidgetTypeCard)}</div>
              </div>
